...
SF_results = EC.plot_results_sharing_factors(plot=False,SF_as_Par=SF_as_Par,SF_required="Consumers").reset_index()
...
SF_results = EC.plot_results_sharing_factors(plot=False,SF_as_Par=SF_as_Par,SF_required="CP").reset_index()
