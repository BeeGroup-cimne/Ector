...
result_EC=EC.plot_results_aggregated_consumption_PV_Bat(plot=False,profit=True)
result_EC["withou_bat"]= result_EC["Consumption"] - result_EC["PV"]
print(result_EC)
print(EC.plot_results_Bat(plot=False))
plt.show()